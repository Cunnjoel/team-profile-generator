...
// const { inherits } = require('util');
    ...
    const init = () => {
        ...
        .then((answers) => {
            ...
            const managerInfo = new Manager({name: answers.name, id: answers.id, email: answers.email, office: answers.office})
            const htmlPageContent = generateHTML({employeInfo, managerInfo});
